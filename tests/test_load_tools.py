...
def test_load_tools_not_a_dir(monkeypatch, tmp_path):
    # TOOLS_DIR is not a directory
    monkeypatch.setattr(load_tools, "TOOLS_DIR", str(tmp_path / "nope"))
    assert load_tools.load_tools() == {}

def test_load_tools_tools_and_metadata(monkeypatch, tmp_path):
