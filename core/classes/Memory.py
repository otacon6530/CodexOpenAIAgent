...
class Memory:
    def __init__(self, *args, **kwargs):
        self.memory = ConversationHistory(*args, **kwargs)

    def get_efficient_prompt(self, *args, **kwargs):
        return self.memory.get_efficient_prompt(*args, **kwargs)

    def add_system_message(self, *args, **kwargs):
        return self.memory.add_system_message(*args, **kwargs)

    def add_user_message(self, *args, **kwargs):
        return self.memory.add_user_message(*args, **kwargs)

    def add_assistant_message(self, *args, **kwargs):
        return self.memory.add_assistant_message(*args, **kwargs)

    def get_messages(self, *args, **kwargs):
        return self.memory.get_messages(*args, **kwargs)

    def get_long_term_context(self, *args, **kwargs):
        return self.memory.get_long_term_context(*args, **kwargs)

    def get_running_summary(self):
        return self.memory.get_running_summary()

    def snapshot(self):
        return self.memory.snapshot()

    def restore(self, snapshot):
        return self.memory.restore(snapshot)